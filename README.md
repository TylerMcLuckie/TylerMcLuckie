...
Creative Developer. Web. Systems. 3D.

Based in Wellington, NZ. I build websites, connect business systems, 
and create digital experiences that solve real problems. My background 
in creative technology and game development shapes how I approach every 
project: thinking in systems, interactions, and outcomes rather than 
just deliverables.

Currently building 3D web experiences, AI-powered workflows, 
data visualisation tools, and immersive training applications, where 
game engine technology meets real business problems.
